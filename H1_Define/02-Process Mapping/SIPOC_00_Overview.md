...
SIPOC 00 — End-to-End Emergency Department Overview

This SIPOC provides a high-level view of the entire Emergency Department workflow from patient arrival to discharge or hospital admission.
...
| Physicians, Nurses, Laboratory, Radiology | Medical orders, Lab results, Imaging requests | 4. Treatment Process | Stabilized patient | Internal: Fast Track / Admission / Discharge |
